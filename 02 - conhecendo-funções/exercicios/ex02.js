...
function main(){
    ...
    if(formaPg === 1){
        alert(`Compra no débito com 10% de desconto R$: ${aplicarDesconto(precoEtiqueta, 10).toFixed(2)}`);
    } else if(formaPg === 2){
        alert(`Compra no cartão em 2x s/Juros R$: ${precoEtiqueta}`);
    } else if(formaPg === 3){
        alert(`Compra no cartão de crédito em até 10x com 10% de Juros R$: ${aplicarJuros(precoEtiqueta, 10).toFixed(2)}`);
    } else if(formaPg === 4){
        alert(`Compre no dinheiro ou pix com 15% de desconto R$: ${aplicarDesconto(precoEtiqueta, 15).toFixed(2)}`);
    } else {
